...
import { japaneseHolidays, getAvailableYears } from '@/src/data/holidays';
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
          <div className="flex gap-2 items-center">
            <button
              ...
              className="px-3 py-2 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 rounded disabled:opacity-50 disabled:cursor-not-allowed"
            >
              ◀
            </button>
            <button
